...
#importarea datelor
train_samples = pd.read_csv("train_samples.csv", dtype = "double", header=None)
train_labels = pd.read_csv("train_labels.csv", dtype = "double", header=None)
test_samples = pd.read_csv("test_samples.csv", dtype = "double", header=None)
...
mlp_classifier_model = MLPClassifier(hidden_layer_sizes=(600,),activation='relu', solver='adam', alpha=0.0001,
                                     batch_size=15000,learning_rate='constant', learning_rate_init=0.002,
